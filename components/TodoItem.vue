  ...
  <li class="todo-item">
    ...
    <div v-else class="edit-container">
      <input
        ...
        class="edit-input"
      />
      <Button @click="finishEditing" icon="pi pi-check" text></Button>
      <Button @click="cancelEditing" icon="pi pi-times" text></Button>
    </div>
    <Button icon="pi pi-trash" severity="danger" text @click="$emit('remove')"></Button>
  </li>
</template>
